...
export default function Footer() {
  ...
  return (
    <footer className="bg-secondary-black text-white mt-20">
      <div className="container mx-auto px-6 lg:px-20 pt-16 pb-12">
        {/* Orange accent line */}
        <div className="h-1 w-24 bg-primary-orange mb-12" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="md:col-span-2 lg:col-span-2">
            ...
            {/* Desktop nav */}
            <nav className="hidden lg:flex gap-8 mb-8">
              {navLinks.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
                  className="text-subtitle hover:text-primary-orange transition-colors"
                >
                  {link.name}
                </Link>
              ))}
            ...
            {/* Mobile/Tablet nav */}
            <nav className="flex lg:hidden flex-col md:flex-row gap-4 md:gap-8 mb-8">
              {navLinks.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
          ...
          {/* Description */}
          <div className="md:col-span-2 lg:col-span-2">
            <p className="text-body text-white/50 mb-8 lg:mb-0">
        ...
        {/* Bottom section */}
        <div className="flex flex-col md:flex-row justify-between items-center mt-12 pt-8 gap-8">
